...
"wwwwwwwwwwwwwtttwwww",
"wwwwwwwwwwwwwwwwwwww",
"wwwwwwttttttttwwwwww",
...
//Show the cursor and let me change what it looks like
    cursor();
    if(creator!=="Mark Z"){
        throw "Ahem. Mark Z is the creator.";
    }
    }
...
//If you click on a battle it takes you there
    ...
    textAlign(CENTER,CENTER);
    textSize(13);
    text("You found the secret level!",200,1480+avatarScroll);
    textAlign(BASELINE);
